...
namespace AlMocar.Areas.Admin.Controllers
{
    ...
    public class AdminItemController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("itemid,Nome,DescricaoCurta,DescricaoDetalhada,ImagemUrl,ImagemPequenaUrl,Valor,Fazendo,CategoriaId")] Item item)
        {
            ...
            ViewData["CategoriaId"] = new SelectList(_context.Categorias, "CategoriaId", "NomeCategoria", item.CategoriaId);
            return View(item);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("itemid,Nome,DescricaoCurta,DescricaoDetalhada,ImagemUrl,ImagemPequenaUrl,Valor,Fazendo,CategoriaId")] Item item)
        {
            if (id != item.itemid)
            {
                return NotFound();
